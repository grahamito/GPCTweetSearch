...
//
//  Extra methods added by Graham Conway for UIRefreshControl
//  ----------------------------------------------------------
//  setupTableViewRefreshControl;
//  coreDataTableviewRefreshAction:(id)sender;
...
// Call from subclass to setup UIRefreshControl for tableview
- (void)setupTableViewRefreshControl;

// override in subclass to implement what happens on refresh
